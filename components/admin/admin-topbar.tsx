...
// Globale topbalk: zoeken (overal) + Quick Actions. Sticky boven de paginainhoud.
// Belletje (notificaties) en NextGen AI komen in een volgende fase in dezelfde balk.
