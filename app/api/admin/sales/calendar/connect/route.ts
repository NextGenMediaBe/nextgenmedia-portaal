...
export async function GET(req: NextRequest) {
  try {
    ...
    // Naam van de persoon wiens agenda we koppelen (Bram, Marco, ...) en welke
    // handtekening onder zijn mails hoort.
    ...
    return NextResponse.redirect(authUrl(pipeline.id, randomUUID(), name, signature))
  } catch (err) {
